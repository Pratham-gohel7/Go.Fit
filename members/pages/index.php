        ...
        <div class="span12">
          ...
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              ...
              <?php
              include "DBcon.php";
              $qry = "SELECT * FROM todo_gofit WHERE Mem_ID='" . $_SESSION['ID'] . "'";
              ...
              while ($row = mysqli_fetch_array($result)) {
                echo "<tbody>
                <tr>
                  <td class='taskDesc'><a href='to-do.php'><i class='icon-plus-sign'></i></a>" . $row['Task'] . "</td>
                  <td class='taskStatus'><span class='in-progress'>" . $row['Status'] . "</span></td>
