...
$qry = "SELECT Gender, count(*) as number FROM member_gofit GROUP BY Gender";
  ...
  <script type="text/javascript">
    ...
    function drawStuff() {
      var data = new google.visualization.arrayToDataTable([
        ...
        <?php
        $query1 = "SELECT Gender, SUM(Amount) as numberone FROM member_gofit; ";
        ...
        <?php
        $query10 = "SELECT Quantity, SUM(Amount) as numbert FROM equipments_gofit";
  ...
  <script type="text/javascript">
    ...
    function drawStuff() {
      var data = new google.visualization.arrayToDataTable([
        ...
        <?php
        $query = "SELECT Package, count(*) as number FROM member_gofit GROUP BY services";
