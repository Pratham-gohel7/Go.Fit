    ...
    <div id="content">
        ...
        <form role="form" action="index.php" method="POST">
            ...
            if (isset($_POST['ename'])) {
                ...
                $qry = "insert into equipments_gofit(Name,Description,Amount,Vendor,Address,Contact,Date,Quantity) values ('$name','$description','$totalamount','$vendor','$address','$contact','$date','$quantity')";
