...
<ul>
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-users"></i> <span>Manage Members</span> <span class="label label-important"><?php include 'actions/dashboard-usercount.php';?> </span></a>
      <ul>
    ...
    <li class="<?php if($page=='feedbacks'){ echo 'active'; }?>"><a href="feedbacks.php"><i class="fas fa-comment"></i> <span>Feedbacks</span></a></li>
    ...
    <ul>
        ...
        <li class="<?php if($page=='c-p-r'){ echo 'active'; }?>"><a href="progress-report.php"><i class="fas fa-arrow-right"></i> Members Progress Report</a></li>
      </ul>
    </li>
