  ...
  <div id="content">
    ...
    <form role="form" action="index.php" method="POST">
      ...
      if (isset($_POST['fullname'])) {
        ...
        //update query
        $qry = "update member_gofit set Name='$fullname', Username='$username',DOJ='$doj', Gender='$gender', Package='$packages', Amount='$amount', Plan='$plan', Address='$address', Contact='$contact', Status='$status' where ID='$id'";
