    ...
    <div id="content">
        ...
        <form role="form" action="index.php" method="POST">
            ...
            if (isset($_POST['name'])) {
                ...
                //update query
                $qry = "update equipments_gofit set Name='$name', Amount='$amount',Vendor='$vendor', Description='$description', Address='$address' , Contact='$contact', Date='$date', Quantity='$quantity' where ID='$id'";
