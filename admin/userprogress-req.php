    ...
    <div id="content">
        ...
        <form role="form" action="index.php" method="POST">
            ...
            if (isset($_POST['ini_weight'])) {
                ...
                //update query
                $qry = "update member_gofit set Ini_Weight='$ini_weight', Curr_Weight='$curr_weight', Ini_BodyType='$ini_bodytype', Curr_BodyType='$curr_bodytype', Progress_Date='$curr_date' where ID='$id'";
