...
<body>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="customer-progress.php" class="current">Members Progress</a> </div>
      <h1 class="text-center">Update Member's Progress <i class="fas fa-signal"></i></h1>
    </div>
          ...
          <div class='widget-box'>
            ...
            <div class='widget-content nopadding'>
              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                <td><div class='text-center'><a href='update-progress.php?id=" . $row['ID'] . "'><button class='btn btn-warning btn'> Update Progress</button></a></div></td>
