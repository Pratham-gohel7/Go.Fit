        ...
        <div class="span12">
          ...
          <div class='widget-box'>
            ...
            <div class='widget-content nopadding'>
              ...
              $search = $_POST['search'];
              $qry = "select * from member_gofit where Name like '%$search%' or Username like '%$search%'";
              $cnt = 1;
        ...
        <thead>
          <tr>
            ...
            <th>Action</th>
                ...
                <td><div class='text-center'><a href='sendReminder.php?id=" . $row['ID'] . "'><button class='btn btn-danger btn'>Alert</button></a></div></td>
