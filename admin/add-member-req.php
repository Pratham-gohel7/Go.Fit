  ...
  <div id="content">
    ...
    <form role="form" action="index.php" method="POST">
      ...
      if (isset($_POST['fullname'])) {
        ...
        $qry = "INSERT INTO member_gofit(Name,Username,Password,DOJ,Gender,Package,Amount,Plan,Address,Contact,Status) values ('$fullname','$username','$password','$doj','$gender','$packages','$totalamount','$plan','$address','$contact','$status')";
