...
<body>
  ...
  <div id="content">
    <div id="content-header">
      ...
      <h1 class="text-center">Go.fit's Staff List <i class="fas fa-briefcase"></i></h1>
    </div>
          ...
          <div class='widget-box'>
            ...
            <div class='widget-content nopadding'>
              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                <td><div class='text-center'><a href='edit-staff-form.php?id=" . $row['ID'] . "'><i class='fas fa-edit' style='color:#28b779'></i> Edit |</a> <a href='actions/remove-staff.php?id=" . $row['ID'] . "' style='color:#F66;'><i class='fas fa-trash'></i> Remove</a></div></td>
                </tr>
